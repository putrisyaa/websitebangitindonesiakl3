        ...
        <div class="container position-relative">
            <div class="row gy-5" data-aos="fade-in">
                ...
                <div class="col-lg-6 order-1 order-lg-2">
                    <img src="assets/img/belanegaraorang.png" class="img-fluid" alt="" data-aos="zoom-out" data-aos-delay="100">
                </div>
            </div>
        </div>
        ...
        <section id="artikel" class="services sections-bg">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-header">
                    <h2>Artikel Tentang Bela Negara Untuk Bangkitkan Semangat Indonesia</h2>
                    <p></p>
                </div>
                    ...
                    foreach ($data as $row) : ?>
                        <div class="col-lg-4 col-md-6">
                            <div class="service-item  position-relative">
                                <p><img src="<?= "admin/img_artikel/" . $row['gambar'] ?>" width="300" height="200"></p>
                                <h3><?= $row['judul'] ?></h3>
                                <p><?= $row['tanggal'] ?></p>
